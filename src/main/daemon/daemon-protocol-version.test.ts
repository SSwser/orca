...
describe('daemon protocol version', () => {
  it('ships bounded history transfer after the 2031-unsubscribe fact', () => {
    ...
    expect(AGENT_SESSION_CREATE_OPERATION_DAEMON_PROTOCOL_VERSION).toBe(39)
    expect(PTY_SPAWN_TARGET_DAEMON_PROTOCOL_VERSION).toBe(39)
    expect(WINDOWS_HOST_CRASH_CONTAINMENT_DAEMON_PROTOCOL_VERSION).toBe(37)
